...
namespace LibraryApp_1
{
    partial class PageBooks
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tabbooksadd.Controls.Add(this.label11);
            this.tabbooksadd.Controls.Add(this.cbxgender);
            this.tabbooksadd.Controls.Add(this.label10);
            this.tabbooksadd.Controls.Add(this.dtdateofbirth);
            this.tabbooksadd.Controls.Add(this.label6);
            this.tabbooksadd.Controls.Add(this.txtclass);
            this.tabbooksadd.Controls.Add(this.label9);
            this.tabbooksadd.Controls.Add(this.txtdepartment);
            this.tabbooksadd.Controls.Add(this.label7);
            this.tabbooksadd.Controls.Add(this.txtstudentphone);
            this.tabbooksadd.Controls.Add(this.label8);
            this.tabbooksadd.Controls.Add(this.txtstudentsurname);
            ...
            this.tabbooksadd.Controls.Add(this.txtstudentname);
            this.tabbooksadd.Controls.Add(this.label2);
            this.tabbooksadd.Controls.Add(this.label1);
            this.tabbooksadd.Controls.Add(this.txtstudentid);
